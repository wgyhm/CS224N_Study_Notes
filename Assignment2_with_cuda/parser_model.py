...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embeddings = nn.Parameter(torch.tensor(embeddings, dtype=torch.float))
    ...
    def forward(self, w):
        ...
        hidden = self.dropout(F.relu(torch.matmul(w, self.embed_to_hidden_weight) + self.embed_to_hidden_bias))
